...
/**
  ...
  * @retval None
  */
void LCD_CMD(unsigned char cmd_data)                                                    //!!!!!!!!!!!!!!!!!!=====CMD
{
...
/**
  ...
  * @retval None
  */
void LCD_printchar(unsigned char ascode)                                        //!!!!!!!!!!!!!!!!!!!!!!!!PRINT CHAR
{
